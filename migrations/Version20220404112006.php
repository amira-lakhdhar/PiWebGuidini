 ...
 */
final class Version20220404112006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP INDEX UNIQ_8F91ABF0DA6A219, ADD INDEX IDX_8F91ABF0DA6A219 (place_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP INDEX IDX_8F91ABF0DA6A219, ADD UNIQUE INDEX UNIQ_8F91ABF0DA6A219 (place_id)');
        $this->addSql('ALTER TABLE avis CHANGE user_id user_id INT DEFAULT NULL, CHANGE place_id place_id INT DEFAULT NULL');
